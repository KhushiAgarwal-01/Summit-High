...
// console.log(formData)
  ...
  const handelSubmit= async(e)=>{
    e.preventDefault();
    try{
      if(formData.imageUrls.length<1) return setError('Image is required')
  ...
  return (
    ...
    {/* left side div */}
      ...
      id='name' maxLength='620' minLength='10' required onChange={handelChange} value={formData.name}
      />

       <textarea type="text" placeholder='Description' className='border p-3 rounded-lg border-gray-500'
      id='description'  required onChange={handelChange} value={formData.description}
      />

    <input type="text" placeholder='Address' className='border p-3 rounded-lg border-gray-500'
      id='address' required onChange={handelChange} value={formData.address}
      />
    ...
    <div className='flex gap-6 flex-wrap'>
      ...
      <div className='flex gap-2'>
          <input type='checkbox' id='sale' className='w-5' 
           onChange={handelChange} checked={formData.type==='sale'} />
          <span className='font-semibold'>Sale</span>
      </div>

      <div className='flex gap-2'>
          <input type='checkbox' id='rent' className='w-5'
          onChange={handelChange} checked={formData.type==='rent'} 
          />
      ...
      <div className='flex gap-2'>
          ...
          onChange={handelChange} checked={formData.parking}
          />
      ...
      <div className='flex gap-2'>
          ...
          onChange={handelChange} checked={formData.furnished}
          />
      ...
      <div className='flex gap-2'>
          ...
          onChange={handelChange} checked={formData.offer}
          />
     ...
     <div className='flex flex-wrap gap-6' >
        ...
        <div className='flex items-center gap-2'>
          ...
          onChange={handelChange} value={formData.bedrooms}
          />
          <p>Beds</p>
        </div>
        ...
        <div className='flex items-center gap-2'>
          ...
          className='p-3  border border-gray-500 rounded-lg  '
          onChange={handelChange} value={formData.bathrooms}
          />
          <p>Baths</p>
        </div>

        <div className='flex items-center gap-2'>
          <input  type='number' id='regularPrice' min='50' max='10000000000' required 
          className='p-3  border border-gray-500 rounded-lg  '
          onChange={handelChange} value={formData.regularPrice}
          />
         ...
         className='p-3  border border-gray-500 rounded-lg  '
         onChange={handelChange} value={formData.discountPrice}
         />
         <div className='flex flex-col items-center'> 
   ...
   <p className='font-semibold '>Images:
...

    {
      formData.imageUrls.length >0 &&  formData.imageUrls.map((url,index)=>(
       ...
       <button type='button' onClick={()=>handelRemoveImage(index)} className='p-3 text-red-700 rounded-lg hover:opactiy-95'> delete</button>
       </div>
      ))
    }
