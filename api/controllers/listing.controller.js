...
export const getListings=async(req,res,next)=>{
    ...
    try{
        ...
        //if this then search for all with offer true as well as false
        if(offer===undefined || offer==='false'){
            offer={ $in: [false,true]};
        }

        let furnished=req.query.funished;
        //if this then search for all with offer true as well as false
        ...
        const listings=await Listing.find({
            name:{$regex:searchTerm,$options:'i'}, //i means  not case sensitive
            offer,
            furnished,
            parking,
            type,
